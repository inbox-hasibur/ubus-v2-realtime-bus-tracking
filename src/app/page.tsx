...
export default function Dashboard() {
  ...
  />
      ...
      <main className="flex-1 relative flex flex-col">
        ...
        {/* --- Right Floating Panel (The Perfect Match) --- */}
          ...
          <div className="bg-white/70 backdrop-blur-xl p-5 rounded-[32px] shadow-2xl border border-white/40 space-y-3">
             <div className="relative group">
                <input 
                  ...
                  className="w-full bg-slate-900/90 text-white text-[11px] p-4 pr-10 rounded-xl outline-none placeholder:text-slate-500 ring-1 ring-white/10 focus:ring-blue-500/50 transition-all"
                />
             ...
             <div className="relative">
                <input 
                  ...
                  className="w-full bg-slate-900/90 text-white text-[11px] p-4 rounded-xl outline-none placeholder:text-slate-500 ring-1 ring-white/10 focus:ring-blue-500/50 transition-all"
                />
             </div>
             <div className="flex gap-2 pt-1">
                <button className="flex-1 bg-[#facc15] hover:bg-[#eab308] text-slate-900 py-3.5 rounded-xl font-black text-xs uppercase shadow-lg shadow-yellow-500/20 active:scale-[0.98] transition-all">
                   Enter
                </button>
                <button className="bg-slate-900 text-white px-4 py-3.5 rounded-xl shadow-lg active:rotate-180 transition-all duration-500">
